...
public:
	...
	void calibrate() 
	{
		...
		{                  //Run this code 2000 times                         //Print a dot on the LCD every 125 readings
			if (cal_int % 200 == 0) 
			{
		...
		Angle accCal = getAccel();

		acc_cal_pitch = accCal.pitch;
...
private:
	...
	int temperature, gyro_x, gyro_y, gyro_z;
	long acc_x, acc_y, acc_z, acc_total_vector;
	float angle_pitch_output, angle_roll_output;
	Angle AccResult,GyroResult;
};
